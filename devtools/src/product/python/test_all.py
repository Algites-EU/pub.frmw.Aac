...
def main() -> int:
    ...
    groups = [
        ...
        ["src/develop/python/algites/lib/aac/coreimpl/lifecycle", "src/develop/python/algites/lib/aac/coreimpl/invocation", "src/develop/python/algites/lib/aac/coreimpl/process", "src/develop/python/algites/lib/aac/coreimpl/subinterpreter"],
