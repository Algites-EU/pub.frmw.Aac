from algites.frmw.aac.codegen import AIcPythonCapabilityBindingGenerator
from algites.frmw.aac.coreimpl.capability import AIcActiveContractCatalog
from algites.frmw.aac.coreimpl.invocation import AIcObjectCapabilityEndpoint
...
def test_data_entity_binding_generator_uses_versioned_view_methods_and_codec():
    ...
    from algites.frmw.aac.codegen import AIcPythonDataEntityBindingGenerator
...
def test_generated_caller_materializes_operation_specific_failure_exception_and_allows_typed_override():
    ...
    from algites.frmw.aac.coreimpl.invocation import AIcCoreCapabilityHandle, AIcEndpointRegistry, AIcInvocationDispatcher
