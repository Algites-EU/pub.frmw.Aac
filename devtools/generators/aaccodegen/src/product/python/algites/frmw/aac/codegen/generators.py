...
from algites.frmw.aac.coreintf.capability import AIcCapabilityContract, AInCapabilityOperationInteractionKind

from algites.frmw.aac.coreimpl.schemas import AIcRegisteredSchema, AIcSchemaRegistry
...
class AIcPythonCapabilityBindingGenerator:
    ...
    def generate(self, contract: AIcCapabilityContract, *, canonical_resource: str | None = None) -> str:
        ...
        chunks = [
            ...
            "from typing import Mapping",
            "from algites.frmw.aac.coreintf.bindings import aig_authorization, aig_operation",
...
class AIcPythonDataEntityBindingGenerator:
    ...
    def generate(self, schema_id: str, version: int) -> str:
        ...
        lines = [
            ...
            "from typing import Mapping",
            "from algites.frmw.aac.coreintf.dataentity import AIcDataEntityType, AIiDataEntityCodec, AIiDataEntityView",
            "",
