...
from algites.lib.aac.coreintf.invocation import (
    AInOperationInteractionEventType, AIcOperationInteractionEvent, AIcOperationInteractionFeatures, AIxOperationCancelled,
...
class AIcOperationProgress:
    def __init__(self) -> None:
        ...
        self._interaction.declare_features(AIcOperationInteractionFeatures(
            progress_reporting=True, cancellation=True, reporting_interval=True
        ))
