...
from algites.frmw.aac.coreintf.capability import AIcProvidedCapability, AInConsumerCardinality
...
from algites.frmw.aac.coreimpl.core import AIcApplicationComponentCore, AIcInstalledComponent
from algites.frmw.aac.coreimpl.descriptor import AIcDiscoveredComponent
from algites.frmw.aac.uiqt.controller import AIcCoreUiController
from algites.frmw.aac.uiintf import AIcUiObservationBinding, AIcUiObservationSelector
...
def test_requirements_include_unresolved_and_preference_uses_instance_ids():
    ...
    provider_descriptor = AIcComponentDescriptor(
        "vendor.provider", 1,
        capability_providers=(AIcProviderDefinitionDescriptor("p", (AIcProvidedCapability("vendor.cap", (1,)),), (AIcProviderImplementationClassDescriptor("python", "vendor:Provider"),)),),
    )
    consumer_descriptor = AIcComponentDescriptor(
        "vendor.consumer", 1,
        capability_providers=(AIcProviderDefinitionDescriptor(
            "c", (AIcProvidedCapability("vendor.consumer-cap", (1,)),), (AIcProviderImplementationClassDescriptor("python", "vendor:Consumer"),),
...
def test_create_provider_instance_can_start_unconfigured():
    ...
    descriptor = AIcComponentDescriptor(
        ...
        capability_providers=(AIcProviderDefinitionDescriptor(
            "p", (AIcProvidedCapability("vendor.configurable-cap", (1,)),), (AIcProviderImplementationClassDescriptor("python", "vendor:Provider"),),
...
def test_scoped_configuration_form_exposes_rw_provider_and_updates_it(tmp_path):
    from algites.frmw.aac.coreimpl.bootstrap import AIcConfigurationBootstrapLoader
...
def test_entitlement_status_exposes_effective_permission_metadata():
    from algites.frmw.aac.coreintf.descriptor import AIcCapabilityEntitlementDescriptor, AIcPermissionDescriptor
...
def test_catalog_browse_download_install_ui_flow(tmp_path):
    ...
    from algites.frmw.aac.coreintf.packages import AIcPackageStoreLayout
    from algites.frmw.aac.coreintf.verification import AIcVerificationOutput, AIiPackageVerifier
    from algites.frmw.aac.coreimpl.bootstrap import AIcCatalogBootstrapLoader
...
'''))
    current_descriptor = AIcComponentDescriptor(
        ...
        capability_providers=(AIcProviderDefinitionDescriptor("main", (AIcProvidedCapability("com.example.ui-cap", (1,)),), (AIcProviderImplementationClassDescriptor("python", "demo:Provider"),)),),
    )
