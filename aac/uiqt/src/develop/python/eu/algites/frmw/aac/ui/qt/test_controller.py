...
from eu.algites.frmw.aac.core.runtime.application import AIcApplicationComponentCore, AIcInstalledComponent
from eu.algites.frmw.aac.core.descriptor.loader import AIcDiscoveredComponent
from eu.algites.frmw.aac.ui.qt.controller import AIcCoreUiController
from eu.algites.frmw.aac.ui.api import AIcUiObservationBinding, AIcUiObservationSelector
...
def test_scoped_configuration_form_exposes_rw_provider_and_updates_it(tmp_path):
    from eu.algites.frmw.aac.core.bootstrap.loaders import AIcConfigurationBootstrapLoader
...
def test_entitlement_status_exposes_effective_permission_metadata():
    from eu.algites.frmw.aac.core.descriptor.api import AIcCapabilityEntitlementDescriptor, AIcPermissionDescriptor
...
def test_catalog_browse_download_install_ui_flow(tmp_path):
    ...
    from eu.algites.frmw.aac.core.packages.api import AIcPackageStoreLayout
