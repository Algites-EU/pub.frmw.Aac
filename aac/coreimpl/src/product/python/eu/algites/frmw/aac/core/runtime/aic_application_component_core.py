...
from .aic_installed_component import AIcInstalledComponent
from .aic_python_candidate_import_snapshot import AIcPythonCandidateImportSnapshot
from .aic_upgrade_outcome import AIcUpgradeOutcome
...
class AIcApplicationComponentCore:
    ...
    def configuration_provider_access(self, configuration_provider_id, configuration_scope, configuration_target, actor_context=None):
        from eu.algites.frmw.aac.core.configuration.api import AIcConfigurationProviderRequest
