...
class AIcActiveContractCatalog:
    ...
    def admit_builtin_contracts(self) -> tuple[AIcAdmittedContract, ...]:
        ...
        contract_resources = (
            ("eu.algites.frmw.aac.core.observation", "definitions/aac-capability-observation_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-get-record_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-query-records_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-apply-direct-record-changes_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-inspect-storage-support_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-ensure-storage-support_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-retire-storage-support_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-create-storage-backup_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-inspect-storage-backup_1.yml"),
            ("eu.algites.frmw.aac.core.dataentity", "definitions/aac-data-entity-restore-storage-backup_1.yml"),
        )
