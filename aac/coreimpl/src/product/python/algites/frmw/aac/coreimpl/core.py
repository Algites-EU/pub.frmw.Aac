...
from algites.frmw.aac.coreintf.authentication import AIcSecurityBootstrap, AIiAuthenticationHandler, AIiSecretProvider
from algites.frmw.aac.coreintf.authorization import AIcAuthorizationPrincipal, AIcComponentAuthorizationGrant, AIiAuthorizationProvider
from algites.frmw.aac.coreintf.catalog import (
...
from algites.frmw.aac.coreintf.dataentity import AIcDataEntityEnvelope, AIcDataEntityImplementationBinding, AIcDataEntityViewBinding
from algites.frmw.aac.coreintf.migration import AInSchemaRuntimeInterpretation
from algites.frmw.aac.coreintf.errors import AIxPersistedSchemaIncompatible
from algites.frmw.aac.coreintf.instances import AIcBindingPreference, AIcProviderInstance, AInProviderInstanceState
from algites.frmw.aac.coreintf.observation import AIcObservationBinding
from algites.frmw.aac.coreintf.persistence import AIiStateStore
from algites.frmw.aac.coreintf.readiness import AIcProviderReadiness, AIcComponentReadiness, AIcCapabilityReadiness
...
from algites.frmw.aac.coreintf.solver import (
    AIcTargetStateRequest, AIcTargetStateSolution, AIcTargetStateSolverResult,
)
from algites.frmw.aac.coreintf.verification import AIiPackageVerifier, AIcVerificationInput
from algites.frmw.aac.coreintf.descriptor import AInComponentOrigin
from algites.frmw.aac.coreintf.capability import AInCapabilityOperationInteractionKind
from algites.frmw.aac.coreintf.interaction_types import AInStateResultDeliveryMode
...
class AIcApplicationComponentCore:
    ...
    def configuration_provider_access(self, configuration_provider_id, configuration_scope, configuration_target, actor_context=None):
        from algites.frmw.aac.coreintf.configuration import AIcConfigurationProviderRequest
