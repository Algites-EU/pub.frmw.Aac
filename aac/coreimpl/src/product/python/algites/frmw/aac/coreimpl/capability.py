...
from algites.frmw.aac.coreintf.capability import (
...
class AIcCapabilityGroupCatalog:
    ...
    def admit_builtin_groups(self) -> tuple[AIcAdmittedCapabilityGroup, ...]:
        resources_to_admit = (
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-capability-group-data-entities_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-capability-group-data-entity-loading_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-capability-group-data-entity-storing_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-capability-group-data-entity-storage-management_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-capability-group-data-entity-storage-backup-restore_1.yml"),
            ("algites.frmw.aac.coreintf.runtime", "definitions/aac-capability-group-runtime_1.yml"),
            ("algites.frmw.aac.coreintf.observation", "definitions/aac-capability-group-runtime-observation_1.yml"),
        )
...
class AIcActiveContractCatalog:
    ...
    def admit_builtin_contracts(self) -> tuple[AIcAdmittedContract, ...]:
        ...
        contract_resources = (
            ("algites.frmw.aac.coreintf.observation", "definitions/aac-capability-observation_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-get-record_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-query-records_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-apply-direct-record-changes_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-inspect-storage-support_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-ensure-storage-support_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-retire-storage-support_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-create-storage-backup_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-inspect-storage-backup_1.yml"),
            ("algites.frmw.aac.coreintf.dataentity", "definitions/aac-data-entity-restore-storage-backup_1.yml"),
        )
        return tuple(self.admit_package_resource(package, resource) for package, resource in contract_resources)
