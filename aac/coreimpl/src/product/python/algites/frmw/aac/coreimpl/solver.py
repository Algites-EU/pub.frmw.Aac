...
from algites.frmw.aac.coreintf.readiness import AInReadinessState
    ...
    def _entitlement_descriptor(candidate: AIcSolverCandidate) -> AIcComponentDescriptor:
        providers = tuple(
            AIcProviderDefinitionDescriptor(
                ...
                implementation_classes=(AIcProviderImplementationClassDescriptor("python", "_AAC.solver.placeholder"),),
            )
