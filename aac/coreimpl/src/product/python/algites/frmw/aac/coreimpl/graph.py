...
from algites.frmw.aac.coreintf.descriptor import AIcComponentDescriptor, AIcConsumerRequirementDescriptor
from algites.frmw.aac.coreintf.instances import AIcBinding, AIcBindingPreference, AIcProviderInstance
