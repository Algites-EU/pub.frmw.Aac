...
from algites.frmw.aac.coreintf.observation import AIcObservationOutput, AIiObservationProvider
...
from algites.frmw.aac.coreimpl.observation import AIcObservationDispatcher, AIcObservationSelector
...
def test_permission_denied_is_normalized_for_core_bridge():
    from algites.frmw.aac.coreintf.entitlement import AInPermissionRetryDisposition
    from algites.frmw.aac.coreintf.errors import AIxPermissionDenied
...
def test_observation_contract_uses_direct_input_object_without_transport_wrapper():
    ...
    from algites.frmw.aac.coreintf.observation import AIcObservationInput, AInObservationPhase
...
def test_effective_operation_parameters_are_separate_from_portable_input_and_visible_to_provider():
    from algites.frmw.aac.coreintf.invocation import current_operation_parameters
...
def test_async_start_uses_same_interaction_lifecycle_and_propagates_locale():
    ...
    from algites.frmw.aac.coreimpl.operation_interaction import AIcOperationInteractionController
    from algites.frmw.aac.coreimpl.invocation import AIcCoreCapabilityHandle, AIcEndpointRegistry
...
def test_simple_synchronous_invocations_get_fresh_on_demand_interaction_state():
    from algites.frmw.aac.coreintf.capability import AIcCapabilityContract, AIcCapabilityOperation, AIcCapabilityRef
    from algites.frmw.aac.coreintf.invocation import current_operation_interaction
