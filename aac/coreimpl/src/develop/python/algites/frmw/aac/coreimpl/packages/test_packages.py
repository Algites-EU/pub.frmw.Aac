...
from algites.frmw.aac.coreintf.descriptor import AIcCapabilityEntitlementDescriptor, AIcComponentDescriptor, AIcEntitlementLicensingScopeDescriptor, AIcPermissionDescriptor, AIcProviderDefinitionDescriptor
...
from algites.frmw.aac.coreimpl.package_documents import AIcPackageBootstrapLoader, AIcWorkspaceComponentLockLoader, AIcWorkspaceComponentRequirementsLoader
from algites.frmw.aac.coreimpl.packages import AIcPackageManager, AIcStaticPackageSource
from algites.frmw.aac.coreimpl.persistence import AIcJsonFileStateStore
...
def test_paid_component_without_implicit_or_effective_permission_blocks_only_automatic_install():
    descriptor = AIcComponentDescriptor(
        ...
        capability_providers=(AIcProviderDefinitionDescriptor(
            "provider", (AIcProvidedCapability("com.example.cap", (1,)),), (AIcProviderImplementationClassDescriptor("python", "com.example:Provider"),)
        ),),
...
packages:
  - component_id: com.example.demo
    ...
    verifier_id: test
""", encoding="utf-8")
    from algites.frmw.aac.coreimpl.packages import AIcManifestPackageSource
...
def test_replacement_cutover_revalidates_core_state_before_first_mutation(tmp_path):
    from algites.frmw.aac.coreimpl.errors import AIxPersistenceRevisionConflict
