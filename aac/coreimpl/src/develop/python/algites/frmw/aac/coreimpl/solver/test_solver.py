...
from algites.frmw.aac.coreintf.solver import AIcTargetStateRequest
from algites.frmw.aac.coreimpl.catalog import AIcStaticCatalogProvider
...
def _descriptor(component_id: str, version: int, *, capability: str, capability_version: int,
    ...
    provider = AIcProviderDefinitionDescriptor(
        "main", (AIcProvidedCapability(capability, (capability_version,)),), (AIcProviderImplementationClassDescriptor("python", "example.Provider"),),
