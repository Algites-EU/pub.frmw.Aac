...
def test_unsupported_versioned_provider_contribution_is_unavailable_and_falls_back_to_default():
    ...
    from algites.frmw.aac.coreintf.descriptor import AIcPersistedSchemaDescriptor
    from algites.frmw.aac.coreimpl.configuration import AIcConfigurationReadService
