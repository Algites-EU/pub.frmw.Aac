...
from algites.frmw.aac.coreimpl.errors import AIxSchemaValidationError
...
def test_simpleaudit_defaults_are_applied():
    ...
    registry.register_package_resource("algites.frmw.aac.simpleaudit", "schemas/simpleaudit-config_1.json")
