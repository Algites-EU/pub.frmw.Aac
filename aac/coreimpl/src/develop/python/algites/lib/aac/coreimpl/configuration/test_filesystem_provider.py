...
def test_versioned_snapshot_is_migrated_and_rewritten_atomically(tmp_path):
    ...
    from algites.lib.aac.coreintf.descriptor import AIcPersistedSchemaDescriptor, AIcSchemaMigrationStepDescriptor
    from algites.lib.aac.coreimpl.configuration import AIcConfigurationProviderRegistry, AIcConfigurationReadService
