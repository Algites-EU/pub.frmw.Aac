...
from algites.lib.aac.coreintf.packages import AIcPackageStoreLayout, AInStoredPackageState
...
from algites.lib.aac.coreimpl.catalog import AIcCatalogDocumentLoader, AIcFilesystemCatalogProvider
...
def test_http_catalog_provider_reads_same_document_and_resolves_relative_artifact_uri(tmp_path):
    ...
    thread.start()
    try:
        from algites.lib.aac.coreimpl.catalog import AIcHttpCatalogProvider
...
def test_catalog_persistent_schema_discriminator_fields_are_strict():
    import pytest
    from algites.lib.aac.coreintf.catalog import AIcCatalogPersistentSchema, AInCatalogPersistentSchemaKind
