...
from eu.algites.frmw.aac.core.configuration.providers import AIcFileSystemConfigurationProvider
from eu.algites.frmw.aac.core.implementation.errors import AIxConfigurationRevisionConflict
...
def test_versioned_snapshot_is_migrated_and_rewritten_atomically(tmp_path):
    ...
    from eu.algites.frmw.aac.core.descriptor.api import AIcPersistedSchemaDescriptor, AIcSchemaMigrationStepDescriptor
    from eu.algites.frmw.aac.core.configuration.runtime import AIcConfigurationProviderRegistry, AIcConfigurationReadService
    from eu.algites.frmw.aac.core.migration.service import AIcConfigurationMigrationService
