...
from eu.algites.frmw.aac.core.implementation.errors import AIxUpgradeError
...
def _write_candidate(root: Path, package: str, *, version: int, broken: bool = False) -> None:
    ...
    (pkg / "provider.py").write_text(
        ...
        "from eu.algites.frmw.aac.core.observation.api import AIiObservationProvider, AIcObservationOutput\n"
...
def test_stored_package_transaction_commits_selection_and_obsoletes_old_artifact(tmp_path: Path):
    ...
    from eu.algites.frmw.aac.core.packages.api import AIcPackageCandidate, AIcPackageStoreLayout, AInStoredPackageState
