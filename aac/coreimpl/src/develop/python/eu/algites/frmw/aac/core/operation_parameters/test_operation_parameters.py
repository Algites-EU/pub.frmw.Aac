...
from eu.algites.frmw.aac.core.operation_parameters.resolver import (
...
def _provider(parameter=None):
    return AIcProviderDefinitionDescriptor(
        ...
        implementation_classes=(AIcProviderImplementationClassDescriptor("python", "example:Provider"),),
