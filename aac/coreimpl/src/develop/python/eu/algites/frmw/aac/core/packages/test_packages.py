...
from eu.algites.frmw.aac.core.descriptor.api import AIcCapabilityEntitlementDescriptor, AIcComponentDescriptor, AIcEntitlementLicensingScopeDescriptor, AIcPermissionDescriptor, AIcProviderDefinitionDescriptor
...
from eu.algites.frmw.aac.core.packages.documents import AIcPackageBootstrapLoader, AIcWorkspaceComponentLockLoader, AIcWorkspaceComponentRequirementsLoader
from eu.algites.frmw.aac.core.packages.store import AIcPackageManager, AIcStaticPackageSource
