...
from eu.algites.frmw.aac.core.implementation.errors import AIxConfigurationPolicyError
...
def test_unsupported_versioned_provider_contribution_is_unavailable_and_falls_back_to_default():
    ...
    from eu.algites.frmw.aac.core.descriptor.api import AIcPersistedSchemaDescriptor
    from eu.algites.frmw.aac.core.configuration.runtime import AIcConfigurationReadService
