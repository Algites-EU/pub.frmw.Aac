...
from eu.algites.frmw.aac.core.verification.api import AIcVerificationInput
from eu.algites.frmw.aac.verify.sigstore import AIcSigstorePackageVerifier, AIcSigstoreTrustPolicy
...
def test_sigstore_entitlement_verifier_uses_issuer_policy(tmp_path: Path):
    ...
    from eu.algites.frmw.aac.verify.sigstore import AIcSigstoreEntitlementEvidenceVerifier
